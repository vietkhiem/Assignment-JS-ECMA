...
const Contact = {
    ...
    <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
        ...
        <a href="#" class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
            ...
            <span class="mt-2">example@fpt.edu.vn</span>
        </a>
    </div>
    ...
    <form action="" id="form-contact">
            ...
            <div class="items-center -mx-2 md:flex">
                <div class="w-full mx-2">
                    ...
                    <input id="title-name" class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" type="text">
                </div>
