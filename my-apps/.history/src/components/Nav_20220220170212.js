    ...
    render() {
        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                -->
                <div class="flex pt-2">
                    <div class="text-black font-bold " id="check-user">${localStorage.getItem("user") ? "<span class=\" hover:text-[#3b82f6]\" id=\"account-email\"></span><span class=\"mx-1\">/</span><span id=\"logout\" class=\" hover:text-[#3b82f6]\"> Đăng xuất</span>" : "<a href=\"/signin\" class=\" hover:text-[#3b82f6]\">Đăng nhập</a><span class=\"mx-1\">/</span><a href=\"/signup\" class=\" hover:text-[#3b82f6]\">Đăng ký</a>"}</div>                      
                </div>
