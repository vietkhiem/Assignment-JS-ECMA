                ...
                <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    ...
                    <div>
                        ...
                        <div class="mt-4 text-center">
                            <ul >
                                <li>Giá cũ ${post.price_old}$</li>
                                <li>>Giá sale ${post.price_new}$</li>
                            </ul>
                            <p class="mt-1 text-sm  line-through text-red-600"> <b>Giá cũ ${post.price_old}$</b> </p>
                            <h2 class="mt-1 text-sm font-sans text-red-600 hover:underline"> <b>Giá sale ${post.price_new}$</b></h2>
                        </div>
                    </div>
                    </div>
                </div>
