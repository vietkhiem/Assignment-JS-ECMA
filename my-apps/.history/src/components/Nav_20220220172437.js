        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                <div class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden">
                    ${localStorage.getItem("user") ? "<span class=\" hover:text-[#3b82f6]\" id=\"email\">XIN CHào</span><span class=\"mx-1\">/</span><a href=\"/\"<span id=\"logout\" class=\" hover:text-[#3b82f6]\"> Đăng xuất</span></a>" : "<a href=\"/sign-in\" class=\" hover:text-[#3b82f6]\">Đăng nhập</a><span class=\"mx-1\">/</span><a href=\"/sign-up\" class=\" hover:text-[#3b82f6]\">Đăng ký</a>"}
                </div>
                <!--
