...
const Blog = {
    async render() {
        ...
        <div class="2xl:container 2xl:mx-auto flex flex-wrap items-start justify-center pt-6 gap-6">
            ...
            ${data.map((blog) => /* html */`
                <div>
                    <img src="${blog.image}"  alt="woman smiling" />
                    <h2 class="text-xl font-semibold leading-5 mt-8 text-gray-800">${blog.title}</h2>
                    ...
                    <p class="text-base mt-4 italic font-italic leading-4 text-gray-600">${blog.time}</p>
                </div>
