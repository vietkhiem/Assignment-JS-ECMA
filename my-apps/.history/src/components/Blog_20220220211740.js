            ...
            ${data.map((blog) => /* html */`
                <div class="overflow-hidden transition-shadow duration-300 bg-white rounded shadow-sm">
                    ...
                    <div class="p-5 border border-t-0">
                        ...
                        <a href="/#/blog-detail" class="transition-colors duration-200 text-blue-gray-900 hover:text-deep-purple-accent-700" aria-label="Category" title="traveling">traveling</a>
                        ...
                        <a href="/#/products-detail/${product.id}" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Learn more</a>
                    </div>
                </div>
                `).join("")}
            </div>
