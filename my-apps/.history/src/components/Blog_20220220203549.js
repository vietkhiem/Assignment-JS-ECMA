            ...
            ${data.map((blog) => /* html */`
                <div class="overflow-hidden transition-shadow duration-300 bg-white rounded shadow-sm">
                    ...
                    <div class="p-5 border border-t-0">
                        ...
                        <a href="/" aria-label="Category" title="Visit the East" class="inline-block mb-3 text-2xl font-bold leading-5 transition-colors duration-200 hover:text-deep-purple-accent-700">${blog.title}</a>
