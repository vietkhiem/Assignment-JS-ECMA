    ...
    async render(id) {
        ...
        <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
            ...
            <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                ...
                <p class="font-semibold line-through lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 text-red-600">${data.price_old}$</p>
                <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 text-red-600">${data.price_new}$</p>
