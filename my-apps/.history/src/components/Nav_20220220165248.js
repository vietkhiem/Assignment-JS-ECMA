    ...
    render() {
        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                -->
                <div class="flex pt-2">
                            <div class="text-black font-bold " id="check-user">${localStorage.getItem("user") ? "<span id=\"email\"></span><span class=\"mx-1\">/</span><span id=\"logout\" class=\" hover:text-[#fdbf08]\"> Đăng xuất</span>" : "<a href=\"/sign-in\">Đăng nhập</a>"}</div>                      
                ...
                ${localStorage.getItem("user") ? `
                        <ul class="flex">
                            ...
                            <li class="flex items-center">Xin Chào : 
                                <a href="/" class="block px-4 py-3" id="email" <a href="/#/sign-in">Sign In</a> ></a>
