    ...
    render() {
        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                <div class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden">
                    ${localStorage.getItem("user") ? "<span class=\" hover:text-[#3b82f6]\" id=\"email\"></span><span class=\"mx-1\">/</span><span id=\"logout\" class=\" hover:text-[#3b82f6]\"> Đăng xuất</span>" : "<a href=\"/sign-in\" class=\" hover:text-[#3b82f6]\">Đăng nhập</a><span class=\"mx-1\">/</span><a href=\"/sign-up\" class=\" hover:text-[#3b82f6]\">Đăng ký</a>"}
                </div>
                
                ${localStorage.getItem("user") ? `
                        <ul class="flex">
                            <a href=\"/sign-in\" class=\" hover:text-[#3b82f6]\">Đăng nhập</a><span class=\"mx-1\">
                            <li class="flex items-center">Xin Chào : <a href="/" class="block px-4 py-3" id="email"></a></li>
