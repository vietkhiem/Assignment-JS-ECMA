        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                -->
                            ...
                            ${localStorage.getItem("user") ? "<span id=\"email\"></span><span class=\"mx-1\">/</span><span id=\"logout\" class=\" hover:text-[#fdbf08]\"> Đăng xuất</span>" : "<a href=\"/sign-in\">Đăng nhập</a>"}</div>                      
                            
                            
                
                ${localStorage.getItem("user") "<a href="">Sign In</a>"? `
                        <ul class="flex">
