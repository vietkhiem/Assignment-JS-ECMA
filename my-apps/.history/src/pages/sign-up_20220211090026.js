        ...
        <div class="flex items-center min-h-screen bg-gray-50">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full">
                    ...
                    <form id="formSignup" action="" class="form" onsubmit="onSubmitForm(this);
                    return false;">
        ...
        formSignup.addEventListener("submit", (e) => {
            ...
            try {
                ...
                const checkUsername = (username) => {
                    ...
                    if (username.length < 5) return "Username cần chưa tối thiểu 5 kí tự !";
                    return true;
                };
                const checkPassword = (password) => {
                    if (!password) return "Hãy nhập Password !";
                    if (password.length < 5) return "Password cần chưa tối thiểu 5 kí tự !";
                    return true;
                };
                ...
                const validation = (username, password) => {
                    ...
                    // validation username;
                    const messageErrorUsername = checkUsername(username);
                    ...
                    // validation password;
                    const messageErrorPassword = checkPassword(password);
