    ...
    <section class="max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-5">
        <form action="" id="form-edit">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">Tên sản phẩm </label>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="emailAddress">Ảnh sản phẩm</label>
                    <input type="file" 
                        id="image-post" 
                        placeholder="Image" 
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">Giá sản phẩm chưa giảm giá</label>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" >Giá sản phẩm đã giảm giá</label>
            ...
            <div class="w-full mt-4">
                    <img src="http://2.bp.blogspot.com/-MowVHfLkoZU/VhgIRyPbIoI/AAAAAAAATtI/fHk-j_MYUBs/s640/placeholder-image.jpg" id="imgPreview" class="float-right w-2/5 h-64" />
            ...
            <div class="flex justify-center mt-6">
                    <button class="px-4 py-2 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Cập nhật sản phẩm</button>
            </div>
