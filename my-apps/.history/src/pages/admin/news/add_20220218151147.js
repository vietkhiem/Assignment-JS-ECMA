...
const AdminAddProductssPage = {
    render() {
        ...
        <main>
            ...
            <section class="max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-5 mb-10">                    
                    <form action="" id="form-add">
                        ...
                        <img src="http://2.bp.blogspot.com/-MowVHfLkoZU/VhgIRyPbIoI/AAAAAAAATtI/fHk-j_MYUBs/s640/placeholder-image.jpg" id="imgPreview" class="float-right w-2/5" />
