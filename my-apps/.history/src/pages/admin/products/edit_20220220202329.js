    ...
    <section class="max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-5">
        <form action="" id="form-edit">
            ...
            <div class="w-full mt-4">
                    ...
                    <textarea  id="desc-post" class="block w-1/2 h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">${data.desc}</textarea>
            </div>
