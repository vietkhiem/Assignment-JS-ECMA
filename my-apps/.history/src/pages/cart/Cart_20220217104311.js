            ...
            <div class="container mx-auto mt-10">
                ...
                <tbody>
                    ...
                    <div class="flex flex-col justify-between ml-4 flex-grow">
                        ...
                        <button data-id="${item.id}" data-id="${item.id}"n class="btn btn-remove  font-semibold hover:text-red-500 text-gray-500 text-xs">Xóa</button>
                        <a href="#" data-id="${item.id}" data-id="${item.id} class="btn btn-remove  font-semibold hover:text-red-500 text-gray-500 text-xs">Remove</a>
                    </div>
                    </div>
                    ...
                    <div class="flex">
                            <span data-id="${item.id}" onclick="minus()" class="focus:outline-none dark:text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer border border-gray-300 border-r-0 w-7 h-7 flex items-center justify-center pb-1">-</span>
                            ...
                            <span data-id="${item.id}" onclick="plus()" class="focus:outline-none dark:text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer border border-gray-300 border-l-0 w-7 h-7 flex items-center justify-center pb-1">+</span>
                    </div>
