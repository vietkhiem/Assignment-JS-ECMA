        ...
        <div class= "max-w-7xl mx-auto">
            ...
            <div class="container mx-auto mt-10">
                ...
                <tbody>
                    ...
                    <div class="flex">
                            <span data-id="${item.id}" onclick="minus()" class="btn btn-increase focus:outline-none dark:text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer border border-gray-300 border-r-0 w-7 h-7 flex items-center justify-center pb-1">-</span>
                            ...
                            <span data-id="${item.id}" onclick="plus()" class="btn btn-decrease focus:outline-none dark:text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer border border-gray-300 border-l-0 w-7 h-7 flex items-center justify-center pb-1">+</span>
                    </div>
