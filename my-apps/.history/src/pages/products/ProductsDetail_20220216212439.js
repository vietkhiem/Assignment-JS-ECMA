        ...
        <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
            ...
            <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                ...
                <div class="lg:mt-11 mt-10">
                    <div class="flex flex-row justify-between">
                        ...
                        <div class="flex">
                            ...
                            <input type="number" id="inputQuantity" value="1" class="border border-black" />                            <span onclick="plus()" class="focus:outline-none dark:text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer border border-gray-300 border-l-0 w-7 h-7 flex items-center justify-center pb-1">+</span>
                        </div>
                    </div>
                ...
                <a href="/cart">
                    <button
                    id="btnAddToCart"
                    class="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100">Add to shopping bag</button>
                </a>
            </div>
