...
const AdminAddProductssPage = {
                    ...
                    <form action="" id="form-add">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input name="price-post-old" id="price-post-old" class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" >
                                </div>

                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" >Prices have dropped</label>
                                <input name="price-post-new" id="price-post-new" class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" >
                            </div>
                        ...
                        <div class="w-full mt-4">
                            <img src="http://2.bp.blogspot.com/-MowVHfLkoZU/VhgIRyPbIoI/AAAAAAAATtI/fHk-j_MYUBs/s640/placeholder-image.jpg" id="imgPreview" class="float-right w-2/5 h-48 rounded-2xl mt-5" />
                                        ...
                                        <textarea name="desc-post"  id="desc-post" class="block w-1/2 h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"></textarea>
                        </div>
    ...
    afterRender() {
        ...
        formAdd.validate({
            rules: {
                "price-post-new": "required",
                "price-post-old": "required",
                "title-post": {
                    required: true,
                    minlength: 5,
                },
            ...
            messages: {
                "price-post-new": "Required to enter this field!",
                "title-post": {
