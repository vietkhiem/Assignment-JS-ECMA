    ...
    <section class="max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-5">
        <form action="" id="form-edit">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">Giá sản phẩm chưa giảm</label>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" >Giá sản phẩm đã giảm</label>
