...
const AdminEditPost = {
    ...
    <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 pt-10">
        <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">${data.id}</h2>
        
        <form action="" id="form-edit">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    <label class="text-gray-700 dark:text-gray-200">Tên sản phẩm</label>
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-200" for="emailAddress">Ảnh sản phẩm</label>
                    <input type="text" 
                        id="image-post" 
                        placeholder="Image" 
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-200">Giá sản phẩm cũ</label>
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-200" >Giá sản phẩm mới</label>
