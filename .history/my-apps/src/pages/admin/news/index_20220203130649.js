                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    ${data.map((post, index) => /* html */ `
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                              <img src="${post.imge}"  width="50"/>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="#" class="text-indigo-600 hover:text-indigo-900">Sửa</a>
                                                <button data-id="${post.id}" class="inline-block bg-indigo-500 hover:bg-indigo-800 text-white text-sm py-2 px-6 rounded mx-4">Xóa</button>
                                            </td>
                                        </tr>
                                        `).join("")}
                                    </tbody>
