            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="mt-6 ">
                    ...
                    <div class="flex justify-center mt-6">
                        <button id="btn" class="px-4 py-2 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Thêm mới</button>
                    </div>
                </div>
                </section>
                </form>
