                            ...
                            <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
                                ...
                                <div class="py-4">
                                    <li class="ml-[38px] flex relative">
                                        <input type="search" id="name-category" class="outline-none focus:ring-indigo-500 focus:border-indigo-500 border-b-2 transition-all duration-300 ease-linear p-[5px] flex-1 block w-full sm:text-sm" placeholder="Search    ...">
            ...
            $("#list-product").innerHTML = data.map((post) => /* html */`
                <div key={post.id} class="rounded-sm">
                    <a href="">
                        ...
                        <a href="/product/${post.id}">${post.name}</a>
