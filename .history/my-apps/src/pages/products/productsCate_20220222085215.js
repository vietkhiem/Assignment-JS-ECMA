...
const ProductsCate = {
    ...
    afterRender() {
        ...
        key.addEventListener("keyup", async () => {
            ...
            $("#list-product").innerHTML = data.map((product) => /* html */`
              <div key={product.id} class="border p-4 w-[270px] hover:border-cyan-300 rounded-sm">
                  <a href="">
                      <img class="py-2" src="${product.image}" alt="">
                      <h3 class="py-[5px]"><a href="/product/${product.id}" class="text-black font-bold text-[14px]">${post.name}</a></h3>
                      <div class="py-[5px]">
                      ...
                      <p class="text-sm text-gray-500 py-[5px]">$${product.price_new}.00 </p>                  
                  </a>
