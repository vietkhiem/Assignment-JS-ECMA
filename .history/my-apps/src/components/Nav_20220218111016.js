            ...
            <div class="flex justify-between "> 
                ...
                ${localStorage.getItem("user") ? `
                        <ul class="flex">
                            ...
                            <li><a href="/#/"><button class="rounded-md flex space-x-2 w-20 h-10 font-normal text-sm leading-3 text-white bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-600 hover:bg-indigo-600 duration-150 justify-center items-center" id="logout" >Logout</button></a></li>
                            </ul>
                    ` : ""}
