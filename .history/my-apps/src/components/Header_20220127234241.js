const Header = {
    render() {
        ...
        <div>
            <div class="relative">
                ...
                <div class="dark:bg-gray-900 bg-gray-50 px-6 py-9">
                    <div class="container mx-auto flex items-center justify-between">
                        ...
                        <ul class="hidden w-8/12 md:flex items-center justify-center space-x-20 ">
                            <li>
                            ...
                            <li>
                                <a href="" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Product</a>
                            </li>
                            <li>
                                <a href="" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Blog</a>
                            </li>
                            <li>
                                <a href="" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Contact</a>
                            </li>
                        </ul>
            ...
            <div role="main" class="flex flex-col items-center justify-center pt-20 mb-10">
