                ...
                <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    ...
                    <div>
                        ...
                        <a href="/news/${post.id}">
                            ...
                            <h2 class="text-2xl text-black ml-4 text-center">${post.name}</h2>
                            
                        </a>
                        
                        <div class="mt-4 ">
                            <ul class="flex mt-1 ">
                                <li class ="line-through px-4 py-2 text-center"> ${post.price_old}$</li>
                                <li class ="px-4 py-2 text-center"> ${post.price_new}$</li>
                            </ul>
